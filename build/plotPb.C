...
*/
  ...
  ntuple->Draw("x:y:z","flagParticle==40 || flagParticle==41 || flagParticle==42 || flagParticle==43 || flagParticle==44");

  c1->cd(3);
  ntuple->SetMarkerColor(3);
  ntuple->Draw("x:y:z","flagParticle==4 || flagParticle==5 || flagParticle==6");
